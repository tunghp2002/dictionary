...
class BuildTransViCanonicalTest(unittest.TestCase):
    def test_rebuild_keeps_rich_fields_only_for_supplement(self):
        with tempfile.TemporaryDirectory() as temp_name:
            ...
            source.write_text("".join(json.dumps(row, ensure_ascii=False) + "\n" for row in (
                {"sense_id": 1000000000001, "meaning": "một", "description": "Old detail.", "examples": [{"en": "One.", "vi": "Một."}], "collocations": ["one day"]},
            ...
            self.assertEqual(rows[0], {"sense_id": 1000000000001, "meaning": "một", "description": "", "examples": [], "collocations": []})
